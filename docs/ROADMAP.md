...
| --- | --- | --- |
| P | **The professional-grade plan** — whiteboard, documents, backend, agent harness, performance; scoped, measured, in ship order. [roadmap/PLAN.md](roadmap/PLAN.md). Written by direct instruction as the follow-on to row 0. | Read it before starting any whiteboard, documents or backend work. |
