...
- Atlas as the corner companion does the companion's reactions in its own style: glowing headphones with its crest's notes pulsing to the beat while the app plays sound, a crescent moon hung on its crest late at night, half-moon lenses of light while a long answer streams, a bell of light for a due reminder, one of its notes held up as a lantern, a snapped link between two notes when offline, and its orbit dimming and slowing as it drifts off to sleep.
- Atlas is a character of its own now (atlas.js): a lean star spirit in the accent colour, one continuous silhouette from a crest swept back from its crown (carrying the logo's linked notes to a bright tip) through a tapered tunic body, with a streamer of light trailing notes, three notes orbiting its waist with trails, and the logo's hub a small star in its chest. Almond eyes with a glint. Fifteen expressions (calm, happy, delighted, laughing, thinking, curious, surprised, confused, sleepy, sad, proud, shy, determined, love, worried), each a mix of brows, lids, eyes, mouth, blush, tilt, body squash, crest and orbit, eased from one to the next. It breathes, blinks (sometimes twice), sways, its streamer flutters and its notes orbit; full body from 96px, head and crest for marks, a simplified head under 28px. Its colours follow the accent and the theme.
