...
- Atlas is a character of its own now (atlas.js): a small star spirit in the accent colour, one continuous gumdrop body with a wisp on its crown, the logo's five linked notes orbiting its head as a halo and the logo's bright hub glowing in its chest. Fifteen expressions (calm, happy, delighted, laughing, thinking, curious, surprised, confused, sleepy, sad, proud, shy, determined, love, worried), each a mix of brows, lids, eyes, mouth, blush, tilt, body squash and halo, eased from one to the next. It breathes, blinks (sometimes twice), sways, and its halo turns; full body from 96px, head and halo for marks, a simplified head under 28px. Its colours follow the accent and the theme.
