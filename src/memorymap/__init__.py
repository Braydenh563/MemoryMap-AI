...
#: email dialogue for them"). The frontend carries the same string in
#: app.js; tests/test_support_email.py keeps the two equal.
SUPPORT_EMAIL = "brayden.hoyle@outlook.com"
