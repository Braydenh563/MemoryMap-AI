...
def _frontend_js() -> str:
    ...
    dashboard.js, settings.js, timeline.js, documents-code.js and
    documents-prose.js concatenated.
    ...
    (2026-09-24). See index.html and app.js's LAZY_MODULES. A check that only read
