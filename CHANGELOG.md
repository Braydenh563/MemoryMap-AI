...
- Atlas is a character of its own now (atlas.js): a lean star spirit in the accent colour, drawn as one silhouette with one outline (arms and legs grow out of the body rather than sitting on it), a crest swept back from its crown carrying the logo's linked notes to a bright tip, one streamer of light trailing two more, and the logo's hub a small star in its chest. Almond eyes with a glint. Fifteen expressions (calm, happy, delighted, laughing, thinking, curious, surprised, confused, sleepy, sad, proud, shy, determined, love, worried), each a mix of brows, lids, eyes, mouth, blush, tilt, body squash and crest, eased from one to the next. It breathes, blinks (sometimes twice), sways and its streamer flutters; full body from 96px, head and crest for marks, a simplified head under 28px. Its colours follow the accent and the theme.
