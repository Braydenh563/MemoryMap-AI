...
- Atlas redrawn a third time, from the owner's chosen reference sheet: a round head on a small lavender body with no neck, two flame tufts of light, large deep eyes with a lit iris and two catchlights, a constellation of linked star points traced inside the chest with a brighter star at the heart, three thin orbit rings with tiny planets about the shoulders, and a galaxy ribbon of navy, nebula and star dots that wraps behind the body, crosses in front of the legs and streams out as a comet tail. Soft translucent gel: one light over the whole figure, a rim shade per part, a soft specular, a thin outline. Every limb is a tapered stem grown from inside the body. The two looks differ in the tufts, brows and lashes; the icon is the head, tufts and eyes.
