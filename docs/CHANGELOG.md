...
- Atlas redrawn a third time, traced from the owner's chosen reference sheet with the proportions measured (head a third of the height, no neck, arms two thirds of a head long, eyes a third of the head wide): a round head on a small lavender body, two flame tufts of light with a wave of hair swept back over them (short for the masculine look, long with a curl for the feminine), large deep eyes with a lit iris and two catchlights, a constellation of linked star points traced inside the chest with a brighter star at the heart, three thin orbit rings with tiny planets about the head, and a galaxy ribbon of navy, nebula and star dots that sweeps down across the chest, crosses the knees and streams out as a white comet tail. The palette is fixed to the references' blue, navy and violet; the accent tints only the glow. Soft translucent gel: one light over the whole figure, a rim shade per part, a soft specular, a thin outline. Every limb is a tapered stem grown from inside the body. The icon is the head, tufts and eyes.
